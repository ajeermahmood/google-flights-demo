...
const tabData = [
  {
    ...
    icon: (
      <CalendarMonthOutlinedIcon
        sx={{ color: "#1a73e8", width: 40, height: 40 }}
      />
    ),
    content: {
  ...
  },
  {
    ...
    icon: (
      <TimelineOutlinedIcon sx={{ color: "#1a73e8", width: 40, height: 40 }} />
    ),
    content: {
            ...
            <Tab
              ...
              label={
                ...
                >
                  ...
                  {/* Only render the arrow when this tab is active */}
                  {selectedTab === index && (
              ...
              sx={{
                ...
                color: "white",
                textAlign: "left",
                backgroundColor: selectedTab === index ? "#394457" : "#202124",
                borderRadius: 2,
                mb: 1,
                p: 2,
